...
**Workflow**: Add CopilotCustomizer to workspace → Run `/BootstrapRepo` (enters CopilotCustomizer orchestrator, which routes to BootstrapRepo subagent) → Assets generate in your project → Close CopilotCustomizer
