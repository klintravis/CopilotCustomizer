...
```
Input: detectedTechStack[] (from repo-analysis skill)
...
- **Planner**: Uses standards to inform asset specifications and recommendations
...
*Integrates with: repo-analysis skill, Planner, Generator, Verifier*
