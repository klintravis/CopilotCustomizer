...
**Workflow Example**:
```
repository-analysis (understand codebase)
  ↓
implementation-planning (create change strategy)
  ↓
VS Code ChangeExecutor agent (execute changes)
  ↓
VS Code VerificationAgent (validate results)
```
