...
Use the repository-analysis skill to:
...
```
Analyze this repository using the repository-analysis skill. 
...
After analysis, you'd use **implementation-planning skill** to plan which customizations to create, then generate them with agents like `AssetGenerator` or `NewCopilotAgent`.
