...
After analyzing your Express.js API (using repo-analysis skill), you need to plan how to implement AI customization. You want to add automated API endpoint generation, database migration helpers, and security validation skills.
...
Use planning skill to create a roadmap.
```
