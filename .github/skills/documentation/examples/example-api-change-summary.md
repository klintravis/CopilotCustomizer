...
Your team just completed implementation of 4 new API endpoints for user management. Using the **documentation skill**, you need to create a comprehensive change summary that documents what changed, why, and how to use it.
...
Can you help me document this change using the documentation skill?
