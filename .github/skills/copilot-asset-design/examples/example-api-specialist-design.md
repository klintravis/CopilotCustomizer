...
Use the copilot-asset-design skill to help me decide 
...
```bash
copilot --skill copilot-asset-design \
...
**Next Phase**:
Use **technical-documentation skill** to write the actual SKILL.md and agent files with full examples and patterns.
